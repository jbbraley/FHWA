function NCHRP_LiveLoadSolver(uID, ModelName, ScratchPath, Node, Parameters, Options, ArgIn, LCStart, FCaseNum, rNum)
...
%% Call Solver
% Result File name
LiveLoadResultPath = [ScratchPath ModelName '_LL.lsa'];
