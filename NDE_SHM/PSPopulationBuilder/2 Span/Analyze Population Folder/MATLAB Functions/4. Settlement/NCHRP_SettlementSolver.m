function SResults = SettlementSolver(SettCaseName,barrCase,mPath, pPath, oPath, nPath, st7Path)
    ...
    [~, FCaseNum] = find(strcmp(FCaseName, SettCaseName));
...
%     SetShellStiffness(propList,'Off',Parameters,Options.St7.uID)
    ...
    % Run Static Solver 
    St7RunStaticSolver(Options.St7.uID, st7Path);
...
%     end
    ...
    % Open Result File
    St7OpenResultFile(Options.St7.uID, st7Path);
