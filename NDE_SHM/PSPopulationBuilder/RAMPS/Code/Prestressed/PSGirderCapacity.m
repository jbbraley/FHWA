...
if NAexitflag==1
    Parameters.Beam.Mn_pos = min(Parameters.Beam.PSSteel.At*Parameters.Beam.PSSteel.Fs.*(Parameters.Beam.d+Parameters.Deck.t-Parameters.Beam.PSCenter-a./2)); % lb-in
elseif NAexitflag==2
