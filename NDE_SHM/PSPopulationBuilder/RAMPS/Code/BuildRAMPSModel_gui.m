function varargout = BuildRAMPSModel_gui(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @BuildRAMPSModel_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @BuildRAMPSModel_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function BuildRAMPSModel_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = BuildRAMPSModel_gui_OutputFcn(hObject, eventdata, handles) 
