...
% set options
options = optimset('Algorithm','interior-point','Display','off','TypicalX',TypicalX);
...
while designFalse == 1 && count < 11
    ...
    if exitflag > 0
        ...
        [Constraints, ~,Beam, Parameters] = DesignCheck(x, CShapes, LShapes, Parameters, Beam, Section,fCall);
