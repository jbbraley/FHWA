...
%     end
    ...
    Parameters.St7Prop(end+1).propName = 'Right Barrier';
    ...
    Parameters.St7Prop(end+1) = Parameters.St7Prop(end);
    Parameters.St7Prop(end).propName = 'Left Barrier';
    Parameters.St7Prop(end).St7PropNum = 2;
    ...
    Parameters.St7Prop(end).propType = 'Beam';
    Parameters.St7Prop(end).elmtNums = [];
    Parameters.St7Prop(end).St7PropNum = 11;
