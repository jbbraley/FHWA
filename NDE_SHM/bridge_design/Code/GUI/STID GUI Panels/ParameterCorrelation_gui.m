...
% Last Modified by GUIDE v2.5 09-Feb-2015 16:48:21
...
% uiwait(handles.guiParameterCorrelation_gui);
...
% --- Executes on button press in pushbtnRunPara.
function pushbtnRunPara_Callback(hObject, eventdata, handles)
% hObject    handle to pushbtnRunPara (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in pushbtnRunMass.
function pushbtnRunMass_Callback(hObject, eventdata, handles)
% hObject    handle to pushbtnRunMass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to sliderPara1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function sliderPara1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sliderPara1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% hObject    handle to sliderPara2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function sliderPara2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sliderPara2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% hObject    handle to sliderPara3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function sliderPara3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sliderPara3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function sliderPara4_Callback(hObject, eventdata, handles)
% hObject    handle to sliderPara4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function sliderPara4_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sliderPara4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
