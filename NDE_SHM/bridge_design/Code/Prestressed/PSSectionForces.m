...
% Interior Girders
WF = [.25*min(Parameters.Length) 12*Parameters.Deck.t Parameters.GirderSpacing];
Parameters.Deck.beff(1) = min(WF);
% Exterior Girders
WF = [0.125*min(Parameters.Length) 6*Parameters.Deck.t Parameters.Overhang];
...
if Parameters.NumDia>0
    ...
    Parameters.Design.Load.DLdiaphragm = 0;
end
...
[Parameters.Design.DF, Parameters.Design.DFV] = LRFDDistFact(Parameters, Parameters.Beam.Int);
