...
for i=1:Parameters.Spans
    ...
    Stress(i).Service(:,2) = Stress(i).Service(:,1)-...
        (max(Parameters.Design.DF*Parameters.Design.IMF*Parameters.Design.Load.M_Max(:,(i-1)*Parameters.Length(i)/12+2:(i)*floor(Parameters.Length(i)/12/2)+1))).'/Parameters.Beam.STst(1);
    ...
    Stress(i).Service(:,5) = Stress(i).Service(:,4)+...
        0.8*(max(Parameters.Design.DF*Parameters.Design.IMF*Parameters.Design.Load.M_Max(:,(i-1)*Parameters.Length(i)/12+2:(i)*floor(Parameters.Length(i)/12/2)+1))).'/Parameters.Beam.SBst(1);
    ...
    Stress(i).Service(:,6) = (-(Parameters.Design.Load.DLcurb+Parameters.Design.Load.DLparapet)*Moment(i).Uniform(12:12:end)-...
        (max(Parameters.Design.DF*Parameters.Design.IMF*Parameters.Design.Load.M_Max(:,(i-1)*Parameters.Length(i)/12+2:(i)*floor(Parameters.Length(i)/12/2)+1))).')/Parameters.Beam.SDst(1)/(Parameters.Beam.E/Parameters.Deck.E);
