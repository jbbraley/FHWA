function [Parameters, exitflag] = PlateGirderDesignASD_CoverPlate(Parameters, CShapes, LShapes)
...
if max([Parameters.Beam.fb1, Parameters.Beam.fb2, Parameters.Beam.fb3, Parameters.Beam.fb4]) > 0.55*Parameters.Beam.Fy
