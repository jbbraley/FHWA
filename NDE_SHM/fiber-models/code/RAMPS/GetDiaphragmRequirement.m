function Parameters = GetDiaphragmRequirement(Parameters, CShapes, LShapes)


Parameters.Dia.Force = 1.14*50/144*Parameters.Beam.d*Parameters.Dia.Spacing; % wind force

if strcmp(Parameters.Dia.Assign, 'Auto')
    if Parameters.Beam.d <= 30
