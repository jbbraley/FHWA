...
% Last Modified by GUIDE v2.5 05-Feb-2015 11:15:11
...
% --- Executes just before EditParameters_gui is made visible.
function EditParameters_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to EditParameters_gui (see VARARGIN)
...
% UIWAIT makes EditParameters_gui wait for user response (see UIRESUME)
...
% --- Executes on button press in pushbtnRun.
function pushbtnRun_Callback(hObject, eventdata, handles)
% hObject    handle to pushbtnRun (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in pushbtnSensitivity.
function pushbtnSensitivity_Callback(hObject, eventdata, handles)
% hObject    handle to pushbtnSensitivity (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in pushbtnApply.
function pushbtnApply_Callback(hObject, eventdata, handles)
% hObject    handle to pushbtnApply (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in pushbtnReset.
function pushbtnReset_Callback(hObject, eventdata, handles)
% hObject    handle to pushbtnReset (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
