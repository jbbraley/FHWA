...
switch loadType
    case 'Truck_Forward'
        % Load
        forcesP = -1*Parameters.Design.Load.A;
        laneLoad = 0;
    ...
    case 'Truck_Backward'
        % Load
        forcesP = -1*Parameters.Design.Load.A(end:-1:1);
        laneLoad = 0;
     ...
     case 'Truck_Forward_Dual'
        % Load
        forcesP = [-1*Parameters.Design.Load.A -1*Parameters.Design.Load.A];
        laneLoad = 0;
        
        dualLength = min([0.8*min(Parameters.Length)-28, 50]); % 50 ft min spacing from back of truck 1 to front of truck 2
                                                               % or with
                                                               % the center
                                                               % axles at
                                                               % 0.4L
    ...
    case 'Truck_Backward_Dual'
        % Load
        forcesP = [-1*Parameters.Design.Load.A(end:-1:1) -1*Parameters.Design.Load.A(end:-1:1)];
        laneLoad = 0;
    ...
    case 'Tandem'
        %Load
        forcesP = -1*Parameters.Design.Load.TD;
        laneLoad = 0;
    ...
    case 'Lane_PatternEven'
        %Load
        forcesP = 0;
        laneLoad = -1*Parameters.Design.LaneLoad/12;
